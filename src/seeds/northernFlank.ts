...
export const northernFlank = {
  ...
  strategicSites: [
    ...
    },
    {
      ...
      latitude: 58.98,
      longitude: 18.08,
      output: "Subterranean naval dry docks & fleet command",
    },
    {
      id: "karlskrona",
      countryId: "sweden",
      ...
      latitude: 56.16,
      longitude: 15.58,
      output: "Swedish Coastal Fleet headquarters",
    },
    {
      id: "upinniemi",
      countryId: "finland",
      name: "Upinniemi Naval Base",
      kind: "naval_base",
      latitude: 60.03,
      longitude: 24.36,
      output: "Finnish Coastal Fleet headquarters",
    },
    {
      id: "helsinki",
      countryId: "finland",
      ...
      latitude: 60.32,
      longitude: 24.96,
      output: "Finnish Air Force capital defense",
    },
    {
      id: "rovaniemi",
      countryId: "finland",
      ...
      latitude: 66.56,
      longitude: 25.83,
      output: "Lapland Air Command Arctic interceptors",
    },
    {
      id: "faslane",
