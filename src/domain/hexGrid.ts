...
const balticCoreHexList: StrategicHexCell[] = [
  ...
  },
  {
    id: "hex-swe-lulea",
    axial: { q: -11, r: 38 },
    name: "Luleå / Norrland Defense Zone (Boden Fortress)",
    centroid: [65.58, 22.15],
    polygon: generateHexPolygon(65.58, 22.15),
    terrain: "forest",
    ownership: { side: "neutral", countryId: "sweden" },
    yields: { fundsRevenue: 25, productionPoints: 30, energyFuel: 15 },
    facilities: ["air_base", "radar_site", "coastal_fort"],
    neighbors: [],
    isCoreTheater: true,
    coldWarContext:
      "Gateway to the high north and the primary Arctic defense bastion of Sweden. Houses the underground Boden Artillery Fortress, the heavy iron ore terminals of the Gulf of Bothnia, and the F 21 Luleå reconnaissance and fighter wing.",
    population: 75000,
    economicActivities: [
      "iron_ore_metallurgy",
      "arctic_warfare_training",
      "air_reconnaissance",
    ],
    childSites: [
      {
        id: "lulea-air",
        name: "F21 Luleå Kallax Air Base",
        kind: "air_base",
        latitude: 65.543,
        longitude: 22.122,
        output: "JA-37 Viggen Arctic air defense",
        status: "operational",
      },
      {
        id: "boden-fortress",
        name: "Boden Artillery Fortress",
        kind: "firing_range",
        latitude: 65.825,
        longitude: 21.689,
        output: "Subterranean heavy fortress artillery",
        status: "operational",
      },
      {
        id: "lulea-ore-port",
        name: "Port of Luleå Iron Ore Terminal",
        kind: "world_port",
        latitude: 65.57,
        longitude: 22.2,
        output: "Strategic Baltic steel & ore lifeline",
        status: "operational",
      },
    ],
  },
  {
    id: "hex-fin-helsinki",
    axial: { q: -7, r: 33 },
    name: "Helsinki / Gulf of Finland Neutral Redoubt",
    centroid: [60.17, 24.94],
    polygon: generateHexPolygon(60.17, 24.94),
    terrain: "urban_metropolis",
    ownership: { side: "neutral", countryId: "finland" },
    yields: { fundsRevenue: 40, productionPoints: 25, energyFuel: 10 },
    facilities: ["naval_base", "air_base", "coastal_fort"],
    neighbors: [],
    isCoreTheater: true,
    coldWarContext:
      "Capital of Finland, headquarters of the Finnish Defense Forces and Gulf of Finland Coast Guard. Upinniemi and Pansio naval bases guard the rocky Finnish archipelago, while Draken and MiG-21 interceptors enforce strict neutrality.",
    population: 500000,
    economicActivities: [
      "maritime_shipbuilding",
      "baltic_neutral_commerce",
      "coastal_fortifications",
    ],
    childSites: [
      {
        id: "upinniemi-naval",
        name: "Upinniemi & Pansio Coastal Fleet Base",
        kind: "naval_base",
        latitude: 60.03,
        longitude: 24.36,
        output: "Turunmaa corvettes & Helsinki missile fast attack craft",
        status: "operational",
      },
      {
        id: "helsinki-vantaa",
        name: "Helsinki-Vantaa Military Wing",
        kind: "air_base",
        latitude: 60.317,
        longitude: 24.963,
        output: "MiG-21bis & Saab 35 Draken QRA interceptors",
        status: "operational",
      },
      {
        id: "parola-armor",
        name: "Parola Panssariprikaati Armor Depot",
        kind: "factory",
        latitude: 61.05,
        longitude: 24.36,
        output: "T-55M modern armor and BMP-1 mechanized battalions",
        status: "operational",
      },
      {
        id: "suomenlinna-coastal",
        name: "Suomenlinna Coastal Artillery Command",
        kind: "firing_range",
        latitude: 60.145,
        longitude: 24.985,
        output: "100mm & 130mm fixed turret coastal batteries",
        status: "operational",
      },
    ],
  },
  {
    id: "hex-fin-lapland",
    axial: { q: -11, r: 41 },
    name: "Rovaniemi / Finnish Lapland Arctic Gate",
    centroid: [66.5, 25.7],
    polygon: generateHexPolygon(66.5, 25.7),
    terrain: "mountain_fjord",
    ownership: { side: "neutral", countryId: "finland" },
    yields: { fundsRevenue: 15, productionPoints: 10, energyFuel: 5 },
    facilities: ["air_base", "radar_site"],
    neighbors: [],
    isCoreTheater: true,
    coldWarContext:
      "Strategic Arctic crossroads bordering Swedish Norrland, Northern Norway, and the Soviet Kola Peninsula. Home to the Lapland Air Command (HavLLv 11) flying Saab 35 Drakens from hardened highway strips and the elite Jaeger Brigade at Sodankylä.",
    population: 45000,
    economicActivities: [
      "arctic_reconnaissance",
      "ski_infantry_mobility",
      "highway_air_operations",
    ],
    childSites: [
      {
        id: "rovaniemi-air",
        name: "Rovaniemi Air Base (HavLLv 11)",
        kind: "air_base",
        latitude: 66.564,
        longitude: 25.83,
        output: "Saab 35FS Draken Arctic interceptors",
        status: "operational",
      },
      {
        id: "sodankyla-jaeger",
        name: "Sodankylä Jaeger Brigade Depot",
        kind: "radar_site",
        latitude: 67.416,
        longitude: 26.59,
        output: "Arctic ski jaeger battalions & Sisu XA-180 APCs",
        status: "operational",
      },
      {
        id: "inari-border-radar",
        name: "Inari Early Warning Radar Station",
        kind: "radar_site",
        latitude: 68.9,
        longitude: 27.02,
        output: "Arctic radar coverage of Kola approach corridors",
        status: "operational",
      },
    ],
  },
