...
A local reference library for creating **mods**, **missions/scenarios**, and **dynamic (Task Force Mode) campaigns** for *Sea Power: Naval Combat in the Missile Age*.
...
- A mod is just a **folder of files** that *shadow* files of the same name in `original\`, based on **load order** set in the in-game **Mod Manager**.
...
- [Steam Guide — *Sea Power Mod Creation Guide*](https://steamcommunity.com/sharedfiles/filedetails/?id=3364482257)
- [Steam Guide — *Task Force Mode Campaign Creation*](https://steamcommunity.com/sharedfiles/filedetails/?id=3756769210)
