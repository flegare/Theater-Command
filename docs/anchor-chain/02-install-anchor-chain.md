...
This guide covers setting up the Anchor Chain preloader and BepInEx runtime for *Sea Power*.
...
Copy the following files and directories into your main *Sea Power* root folder (e.g., `S:\SteamLibrary\steamapps\common\Sea Power\`):
